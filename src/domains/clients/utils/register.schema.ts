...
const IDENTITY_CONFIG = {
  0: {
    ...
    regex: /^\d{8,16}$/,
    message: 'رقم البطاقة يجب أن يكون من 8 إلى 16 رقم',
    requiredMessage: 'رقم البطاقة الشخصية مطلوب',
  },
  1: {
    label: 'رقم جواز السفر',
    regex: /^\d{6,20}$/,
    message: 'رقم الجواز يجب أن يكون أرقام فقط (6 إلى 20)',
    requiredMessage: 'رقم جواز السفر مطلوب',
  },
  2: {
    label: 'رقم السجل التجاري',
    regex: /^\d{5,15}$/,
    message: 'رقم السجل التجاري يجب أن يكون أرقام فقط (5 إلى 15)',
