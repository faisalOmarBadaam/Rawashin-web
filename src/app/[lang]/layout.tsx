...
export const metadata = {
  title: 'Rawshin Dashboard',
  description: 'Rawshin Dashboard'
}
  ...
  return (
    <TranslationWrapper headersList={headersList} lang={lang}>
      <html id='__next' lang={lang} dir={direction} suppressHydrationWarning>
        <body className='flex is-full min-bs-full flex-auto flex-col bg-backgroundDefault' suppressHydrationWarning>
